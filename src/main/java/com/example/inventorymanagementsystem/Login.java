...
public class Login extends JFrame {
    ...
    private void initComponents() {
        ...
        this.jLabel3.setText("    INVENTORY MANAGEMENT SYSTEM");
        ...
        this.jTable1.setModel(new DefaultTableModel(new Object[][]{{"jsasu", "password", "administrator"}}, new String[]{"Username", "Password", "Type"}) {
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        ...
        } else if (username.equals("jsasu") && password.equals("password")) {
            com.example.inventorymanagementsystem.Admin log = new com.example.inventorymanagementsystem.Admin();
            log.setVisible(true);
